                        ...
                        <div className="card background-333333 texto-laranja card-usuario">
                            <div className="row">
                                <div className="col-12">
                                    <div className="row">                                        
                                        <div className="col-4 tab1 text-center"><img className="icone-tab1" src={IconeJogo} alt="" title=""/></div>
                                        <div className="col-4 tab2 text-center"><img className="icone-tab2" src={IconeAcessorio} alt="" title=""/></div>
                                        <div className="col-4 tab3 text-center"><img className="icone-tab2" src={IconeConsole} alt="" title=""/></div>
                                    </div>
                                </div>
                            </div>
